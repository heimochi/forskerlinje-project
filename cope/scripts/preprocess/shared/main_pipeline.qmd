...
```{r setup}
# Load functions
source("cope/scripts/preprocess/shared/utilities.r") #small helpers
source("cope/scripts/preprocess/shared/01_filter.r") #filter_clinical_data
```
...
data <- filter_clinical_data(data)
print(summarize_patient_counts(data))
data <- 
